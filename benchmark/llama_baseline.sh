...
# bash benchmark/llama_baseline.sh 7b 4096 2 2 2 512 1 pack hostfile_49
...
# !!!megatron rmsnorm performance is pool
LLAMA_ARGS="
    ...
    --hidden-dropout 0
"
# no use --apply-query-key-layer-scaling
...
mkdir -p ${LOG_FOLDER}
LOGFILE=${LOG_FOLDER}/llama_megatron_gpus${NUM_GPUS}_${MODEL}_seqlen${SEQ_LEN}_gbs${GLOBAL_BATCH_SIZE}_mbs${MICRO_BATCH_SIZE}_dp${D_P}_tp${M_P}_pp${P_P}_${PACK}.log
